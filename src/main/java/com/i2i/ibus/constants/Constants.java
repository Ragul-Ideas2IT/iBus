...
public class Constants {
    ...
    public static final String INVALID_BUS_NUMBER_PATTERN_MESSAGE = "Given bus number is not valid (eg: TN23BS3241)";
    ...
    public static final String INVALID_DESTINATION_PATTERN_MESSAGE = "Given destination is not valid (eg: chennai)";
    ...
    public static final String INVALID_STOP_PATTERN_MESSAGE = "Given stop is not valid (eg: guindy)";
